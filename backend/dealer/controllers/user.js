...
try {
    const {name , email  ,pannumber ,  license ,phone , password }= req.body;
    ...
    const userdetail = await user.create({name : name , email : email , pannumber : pannumber, license :  license,phone : phone , password :hashedpassword  });
