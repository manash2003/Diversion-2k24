...
if (isuserAuthenticated) return <Navigate to={"/"} />;
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center  py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="form opacity-100 absolute bg-transparent p-10 w-96 rounded-lg shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
        <div className="text-center">
          <h2 className="mt-6 text-center text-3xl font-extrabold text-white login">
            User Login 
          </h2>
        </div>
        <form className="mt-8 space-y-2" onSubmit={submitHandler}>
          ...
          <div>
            ...
            <p className="text-center mb-6 text-white ">New here? <a href="/usersignup" className='text-white underline font-bold hover:text-black'>Create New User Account</a></p>
          </div>
        </form>
      </div>
    </div>
