    ...
    <li>
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between">
        <div className="mb-8 md:w-1/4">
          ...
          <p>Email: agrolife@gmail.com</p>
          <p>Phone: +91 8670824999</p>
        </div>
        ...
        <div className="md:w-1/4">
          <h1 className="text-xl font-bold mb-4">We Accept </h1>
          <ul>
          <li><img src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/payment-method_69e7ec.svg" /></li>
          </ul>
        </div>
      </div>
