...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe=await loadStripe("pk_test_51Of85CSCZLmNpUQfUo5o1XvMrTwt6xKO3237skCnlfuMZbj4SWir38uttsT7NRmyV9ZSCQGKEaIUEl9NQwyvJGpi00KpkZpbNQ")
                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th className='text-right'><button className='btn btn-success text-black' onClick={makePayment} type='button'>Checkout</button></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                }
