...
const ContactPage = () => {
  const {user,setUser, dealer , setDealer , isdealerAuthenticated,setIsdealerAuthenticated , isuserAuthenticated, setIsuserAuthenticated}= useContext(Context)
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-transparent p-5 rounded w-96 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
